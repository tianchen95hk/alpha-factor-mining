...
class Settings:
    ...
    BACKTEST_END_DATE = os.getenv("BACKTEST_END_DATE", "2026-03-16")
    INITIAL_CAPITAL = 100000
    TAKER_FEE = 0.001
    BACKTEST_TOP_QUANTILE = float(os.getenv("BACKTEST_TOP_QUANTILE", "0.15"))
    BACKTEST_MAX_ABS_WEIGHT = float(os.getenv("BACKTEST_MAX_ABS_WEIGHT", "0.15"))
    BACKTEST_VOL_LOOKBACK = int(os.getenv("BACKTEST_VOL_LOOKBACK", "48"))
    BACKTEST_MULTI_FACTOR_TOP_K = int(os.getenv("BACKTEST_MULTI_FACTOR_TOP_K", "6"))
    BACKTEST_SIGNAL_SMOOTHING_SPAN = int(os.getenv("BACKTEST_SIGNAL_SMOOTHING_SPAN", "10"))
    BACKTEST_EXECUTION_ALPHA = float(os.getenv("BACKTEST_EXECUTION_ALPHA", "0.20"))
    BACKTEST_REBALANCE_INTERVAL = int(os.getenv("BACKTEST_REBALANCE_INTERVAL", "24"))
    BACKTEST_TARGET_GROSS_EXPOSURE = float(os.getenv("BACKTEST_TARGET_GROSS_EXPOSURE", "0.80"))
    ...
    FACTOR_CORR_THRESHOLD = float(os.getenv("FACTOR_CORR_THRESHOLD", "0.75"))
    FACTOR_DIVERSIFY_POOL_SIZE = int(os.getenv("FACTOR_DIVERSIFY_POOL_SIZE", "80"))
    SYMBOLS = [
        s.strip()
